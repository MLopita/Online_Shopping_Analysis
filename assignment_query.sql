...
SELECT
  ROUND(100 * SUM(CASE WHEN payment_installments > 1 THEN 1 ELSE 0 END) / COUNT(*), 2) AS pct_paid_in_installments
FROM payments;
...
SELECT c.customer_city,
       ROUND(AVG(ipo.items_count),2) AS avg_products_per_order
FROM orders o
